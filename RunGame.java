...
public class RunGame {
    ...
    public static void BeginGame(Player player, Player opponent, Scanner input, boolean isAI) {
        int turnCounter = 1;
    ...
    public void gameSelect(Scanner input) {
    	int gameSelected = selectMode(input);
        	...
        	if(gameSelected == 100){
        		...
        		BeginGame(player1, player2, input, true);
        	}
        	...
        	if(gameSelected == 200){
        		...
        		Player player2 = new Player();
        		player2.SetBoardRandomly();
        		BeginGame(player1, player2, input, false);
        	}	
